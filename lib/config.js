...
startapp.config(['$stateProvider', '$urlRouterProvider', '$controllerProvider', "$compileProvider", "$filterProvider", "$provide", function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide) {
  ...
  $stateProvider
    ...
    */
    ...
    // 1
    .state("gauge-car-dark", {
      url: "/gauge-car-dark",
      templateUrl: addToken("html/examples/gauge-car-dark/mod.html"),
      resolve: {
        delay: startapp.asyncjs('html/examples/gauge-car-dark/mod.js')
      },
      controller: "gaugeCarDarkController"
    })
    // 2
    .state("tree-radial", {
      url: "/tree-radial",
